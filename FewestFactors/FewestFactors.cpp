...
Even though I passed all the test cases provided by myuni, 
I still did not submit the test via the web.
I spent a lot of time figuring out the problem. 
Finally, I found that the web submission tester will reuse my class objects. 
Therefore, some variables have not been reset to initialization.
